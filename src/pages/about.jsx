...
export default function About() {
  return (
    <>
      <Head>
        <title>About - Ethan Blumenthal</title>
        <meta
          name="description"
          content="I’m Ethan Blumenthal. I live in Austin, Texas, where I design the future."
        />
      </Head>
        ...
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:order-first lg:row-span-2">
            <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
              Hi, I’m Ethan Blumenthal From Austin, TX
            </h1>
          ...
          <div className="lg:pl-20">
            <ul role="list">
              <SocialLink href="https://twitter.com/ethanblumenthal" icon={TwitterIcon}>
                Follow on Twitter
              </SocialLink>
              <SocialLink href="https://www.linkedin.com/in/ethanblumenthal" icon={LinkedInIcon} className="mt-4">
                Follow on LinkedIn
              </SocialLink>
              <SocialLink href="https://github.com/ethanblumenthal" icon={GitHubIcon} className="mt-4">
                Follow on GitHub
              </SocialLink>
              <SocialLink
                href="mailto:ethan.blumenthal@gmail.com"
                icon={MailIcon}
                className="mt-8 border-t border-zinc-100 pt-8 dark:border-zinc-700/40"
              >
                ethan.blumenthal@gmail.com
              </SocialLink>
            </ul>
          </div>
        </div>
